                ...
                <div className=' w-11/12 mx-auto flex-col-reverse lg:flex  lg:flex-row items-center gap-10 justify-center'>
                    ...
                    <div className=' lg:w-1/2'>
                        ...
                        <div className='space-y-5'>
                            <h1 className='lg:text-5xl text-2xl md:text-4xl  font-bold '>We invite you to <br />
                                visit our restaurant</h1>
                            <p className="">Restaurants offer a diverse culinary experience, serving delectable dishes ranging from appetizers to desserts. They showcase regional and international cuisines, catering to various tastes. Quality ingredients, skilled chefs, and creative presentation enhance the dining experience. Restaurants provide a social ambiance, making them hubs for family gatherings, celebrations
                            </p>
