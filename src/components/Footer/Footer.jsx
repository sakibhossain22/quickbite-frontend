            ...
            <footer className="footer p-10 bg-neutral text-neutral-content">
                <aside>
                    <div className="flex gap-5 items-center justify-center">
                        ...
                        <h1 className="text-xl uppercase font-bold">Quick Bite</h1>
                    </div>
                    <p><span className="font-bold">QuickBite</span> Industries Ltd.<br />Providing Quality Food since 1992</p>
                </aside>
                <nav>
                    ...
                    <div className="grid grid-flow-col gap-4">
                        ...
                        <div>
                            <h1>Email : web@quickbite.com</h1>
                            <h1>Phone : +88019999999999</h1>
                            <address>address : 2359 Karen Lane</address>
                        </div>
                </nav>
            </footer>
        </div>
